...
//    // Initializer
//    init(question: String, questiontype: String, possibleAnswers: [String], correctAnswer: String) {
...
// struct uses less memory, no object oriented stuff; heritage, class uses more
